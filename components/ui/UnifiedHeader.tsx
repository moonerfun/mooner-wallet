/**
 * UnifiedHeader - Shared header component for all tab screens
 * Shows profile avatar on the left and search bar on the right
 * Includes SearchModal that opens when tapping the search bar
 */
...
export function UnifiedHeader({ onProfilePress }: UnifiedHeaderProps) {
